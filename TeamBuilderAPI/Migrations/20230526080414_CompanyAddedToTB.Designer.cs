...
namespace TeamBuilderAPI.Migrations
{
    ...
    [Migration("20230526080414_CompanyAddedToTB")]
    partial class CompanyAddedToTB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeamBuilderAPI.Models.EventCentre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e36c05b9-620d-436d-97a8-3cba26570062"),
                        ...
                        new
                        {
                            Id = new Guid("ac5c4d36-6c03-40f2-8c06-bb1fd7849561"),
                        ...
                        new
                        {
                            Id = new Guid("28537ed4-4366-4912-96d1-58f3fb0c0880"),
            ...
            modelBuilder.Entity("TeamBuilderAPI.Models.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bba44465-e237-43c7-8d51-8c818c1d2212"),
                        ...
                        new
                        {
                            Id = new Guid("d7e0a2d9-b0f3-4d68-9a54-ffbc9d424aec"),
                            BookRestaurant = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Capacity = 90,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            LastModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("2b5f361f-004b-4323-a1bb-15eb1cd40a97"),
                            BookRestaurant = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Capacity = 60,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            LastModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
