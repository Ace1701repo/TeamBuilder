...
namespace TeamBuilderAPI.Migrations
{
    ...
    [Migration("20230525075514_EmployeeCompany")]
    partial class EmployeeCompany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeamBuilderAPI.Models.EventCentre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3db96146-a725-41e3-8128-519e59414ddc"),
                        ...
                        new
                        {
                            Id = new Guid("e327817c-8c34-4695-958e-4853e826b173"),
                        ...
                        new
                        {
                            Id = new Guid("8d5db5a4-0732-4c01-87df-40fb5771e386"),
            ...
            modelBuilder.Entity("TeamBuilderAPI.Models.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("680fe013-5fd7-44eb-b924-2bc26c828f7b"),
                            Capacity = 60,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            LastModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("6c46abd2-f8aa-4bc4-8afb-e8d6cf0525b2"),
                            Capacity = 90,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            LastModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("bcc25502-c3f5-429d-aed7-9646579b7135"),
                            Capacity = 60,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            LastModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
